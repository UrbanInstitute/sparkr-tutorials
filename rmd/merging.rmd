...
```{r, include=FALSE}
library(SparkR)
sc <- sparkR.init(sparkEnvir=list(spark.executor.memory="4g", spark.driver.memory="2g", spark.driver.maxResultSize="2g"), sparkPackages="com.databricks:spark-csv_2.11:1.4.0")
